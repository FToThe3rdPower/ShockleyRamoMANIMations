...
class ShockleyRamoStripDetector(Scene):
    """
...
class ShockleyRamoWeightingFields(Scene):
    """
...
if __name__ == "__main__":
    # Render with: manim -pql shockley_ramo_strips.py ShockleyRamoStripDetector
    # Or: manim -pql shockley_ramo_strips.py ShockleyRamoWeightingFields
    pass
